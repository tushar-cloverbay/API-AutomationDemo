...
public class Scenario_4_3 extends Base{
	...
	public void submitPrepare_WithDifferentFileType(String version) throws IOException {
		extentTest.log(LogStatus.PASS, "Test Description : " + "Test for getting Prepared Enveloped ID with different file type");
		apiVersion = version;
	...
	public void submit_WithDifferentFileType(String version) throws IOException {
		extentTest.log(LogStatus.PASS, "Test Description : " + "Test for Submit Prepare with different file type");
		apiVersion = version;
		String token =TestUtils.getToken(version);
